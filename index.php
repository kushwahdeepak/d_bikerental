...
<title>wheeler Rental Portal</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Find Your Perfect wheeler</h1>
            <p>We have more than a thousand wheelers for you to choose. </p>
    ...
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">New wheeler</a></li>
        </ul>
      </div>
